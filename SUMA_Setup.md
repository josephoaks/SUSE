...
&emsp;Step 1: run `yast susemanager_setup`<br>
&emsp;Step 2: choose either from scratch or migrate, for this we will setup from scratch<br>
&emsp;Step 3: set the administrator email address<br>
&emsp;Step 4: certificate setup<br>
&emsp;Step 5: setup the database user/password (after this it will run the setup)<br>
&emsp;Step 6: visit the URL that is presented (usually the https://fqdn) and setup your administrator account and continue the setup and configuration of SUMA<br>
